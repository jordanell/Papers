...
of indirect conflicts surrounding source code changes that involved the source
code being changed and the developers involved in those changes. These indirect
...
%Outline of study
In this study, I report on research into supporting indirect conflicts
