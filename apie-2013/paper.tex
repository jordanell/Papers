...
We took ChangeDistiller and applied it across 10 open source Java projects. Java projects were necessary because ChangeDistiller only works for Java source code.
...
In future work, we have planned further statistical tests of the change trends identified in this paper. We would like to
