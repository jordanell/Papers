...
\begin{itemize}
	...
	\item Built in language features to either the source code architecture (i.e. Eiffle or 
...
tools are used for indirect conflicts alone (automatic debugging, unit tests, etc), most of these tools
