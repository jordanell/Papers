...
and frequent problem in software development, contextual patterns of indirect conflicts have been missed in previous tools through
the lack of dependency identification, that developers tend to prefer to use detection and resolution processes or tools
over those of prevention, and that developers do not want awareness mechanisms which provide non actionable results.
