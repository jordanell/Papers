...
cource projects, and a survey with 78 responses. Through grounded theory techniques, 
we found that: indirect conflicts are a real and frequent problem in
...
Lastly, social factors have also shown to cause issues as Cataldo et al.~\cite{Cataldo:2006:ICR} notion of socio-technical
congruence has been leveraged in several indirect conflict tools~\cite{Kwan:2011:ESC, Begel:2010:CDE, Borici:2012:CHA}.
Issues again of information overload, dependencies (of developer organizational structure), and scalability come up.
...
developers, as well as 5 confirmatory interviews, in order to answer the aforementioned questions. Our findings indicate that: 
indirect conflicts are very much a real 
...
from developer opinion, before a mature point is reached in the project's evolution. (This mature point cmay stem from a major release,
